...
class VGG(chainer.Chain):
    ...
    def __call__(self, x):
        ...
        h = F.max_pooling_2d(F.relu(self.conv1_2(h)),2,stride=2)
        h = F.relu(self.conv2_1(h))
        h = F.max_pooling_2d(F.relu(self.conv2_2(h)),2,stride=2)
        h3_2 = F.relu(self.conv3_1(h))
        h = F.relu(self.conv3_2(h3_2))
        h = F.max_pooling_2d(F.relu(self.conv3_3(h)),2,stride=2)
        h4_2 = F.relu(self.conv4_1(h))
        #h4_2 = F.relu(self.conv4_2(h))
        """
